...
ちなみに200barのシリンダーが50barになるおよその時間目安は40分ほど（水深18mに居た場合）。
1ダイブの時間は30分を目安にすると良い。

## 限定水域演習チェックリスト

- [ ] ブリーフィングとダイブ・プランニング
- [ ] エア・マネージメント
- [ ] 器材のセッティング、装着、調整、プレダイブ・セーフティ・チェック
- [ ] エントリー – ジャイアント・ストライド（推奨）
- [ ] 適正ウエイトとウエイト・チェック
- [ ] スノーケル・クリア
- [ ] スノーケル/レギュレーター交換
- [ ] 水面移動 – 正しい水面習慣
- [ ] 目標物ありのファイブポイント潜降
- [ ] 中性浮力 – フィンピボット（推奨）
- [ ] 緩んだシリンダー・バンド（推奨 – ダイブ・フレキシブル）
- [ ] 全部に水を入れたマスクをクリア
- [ ] マスク脱着とマスクなし呼吸
- [ ] パワー・インフレーターの中圧ホースを外す（推奨 – ダイブ・フレキシブル）
- [ ] エア（ガス）切れの練習
- [ ] 目標物ありのファイブポイント浮上
- [ ] スキル練習と遊びのフリータイム
- [ ] エキジット – ラダーエキジット（推奨）
- [ ] ディブリーフィング
- [ ] ダイビング後の器材の手入れ（ダイブ・フレキシブル）
